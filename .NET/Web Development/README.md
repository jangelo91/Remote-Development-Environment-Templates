...
## Getting Started with .NET Remote Development Containers

1. Clone this repository from GitHub

2. Reopen your local copy of this folder (/.NET/Base) in VS Code
...
6. Once the container is built, open Test.NET and run the test file (press F5 or navigate to Run > Start Debugging)
